...
namespace CtLab.Messages.Standard.Specs
{
        ...
        : QueryCommandSchedulerInteractionSpecs
    {
        ...
        {
            _queryCommandDictionaryMock.Verify(sender => sender.SendCommands(It.IsAny<Predicate<QueryMode>>()), Times.Once);
        }
    }
        ...
        : QueryCommandSchedulerInteractionSpecs
    {
        ...
        public void then_the_SUT_should_tell_the_associated_dictionary_once_per_period_to_send_the_commands()
        {
            ...
            _queryCommandDictionaryMock.Verify(sender => sender.SendCommands(It.IsAny<Predicate<QueryMode>>()), Times.Between(5, 6, Range.Inclusive));
        }
    }
}
