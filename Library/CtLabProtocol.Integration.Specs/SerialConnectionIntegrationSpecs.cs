...
namespace CtLab.CtLabProtocol.Integration.Specs
{
    ...
    public class When_getting_the_serial_connection_multiple_times
        : SerialConnectionIntegrationSpecs
    {
    ...
    public class When_getting_the_serial_connection_in_a_generic_and_in_a_specific_way
        : SerialConnectionIntegrationSpecs
    {
        protected override void When()
        {
    ...
    public class When_getting_serial_string_sender_and_receiver_multiple_times
        : SerialConnectionIntegrationSpecs
    {
        protected override void When()
        {
