...
namespace CtLab.Frontend.ViewModels
{
    ...
    /// </summary>
    public class DdsGeneratorAmplitudeScaleInputViewModel
        : LinearScaleInputViewModel<short>, IScaleInputViewModel
    {
        private const double maxExternalValueAsShownOnControl = 100.0; // %, mV, etc.
        ...
        private const double overviewTickInterval = 25;
        ...
        public DdsGeneratorAmplitudeScaleInputViewModel(IApplianceServices applianceServices,
