...
{
    /// <summary>
    /// Writes the amplitude and phase of a DDS generator by setting the value of a set
    /// command that can be sent to a c't Lab FPGA device configured as an FPGA Lab.
    /// </summary>
    public class AmplitudePhaseWriter : SubchannelWriterBase
    {
        ...
        /// </param>
        public AmplitudePhaseWriter(ISubchannelValueSetter subchannelValueSetter)
