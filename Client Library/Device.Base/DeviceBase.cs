...
namespace CtLab.Device.Base
{
    ...
    public abstract class DeviceBase : IDevice
    {
        ...
        protected DeviceBase(byte channel, ISetCommandClassDictionary setCommandClassDictionary, IQueryCommandClassDictionary queryCommandClassDictionary, IMessageCache receivedMessagesCache)
        {
